...
from .views import home, register, timezone, meeting, members, add_members, feedback, viewmeet, viewresponse
...
urlpatterns = [
	...
	url(r'^viewresponse/(?P<hm>[\w]+)$', viewresponse, name='viewresponse'),
]